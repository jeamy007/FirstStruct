...
$.extend({
    ...
    formatCellPhone: function (value) {
        return value.replace(/[-]/g, "").replace(/[ ]/g, "").replace("+86", "");
    },
    ...
    dateDiff: function (dfrom, dto, type) {
        ...
        switch (type) {
            ...
            case 'm': return (dtto.getFullYear() - dtfrom.getFullYear()) * 12 + dtto.getMonth() - dtfrom.getMonth();
        }
    },
...
$.fn.floatdiv = function (location) {
    ...
    return this.each(function () {
        ...
        $(this).css("z-index", "100000000000000000000000").css(loc).css("position", "fixed");
        if (true) {
